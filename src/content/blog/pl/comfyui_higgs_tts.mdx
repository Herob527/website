...
description: 'Poznaj przykład wykorzystania ComfyUI do generowania głosów za pomocą HiggsTTS'
date: '2026-07-01'
---
...
3. Następnie trzeba zescrollować w górę do kategorii `Comfy nodes` i kliknąć w audio i przeciągnąć `Save Audio` oraz `Load Audio`
