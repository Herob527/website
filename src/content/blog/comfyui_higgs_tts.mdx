...
<div flex="~ md:row col" gap="1" items="center" >
...
<Image src={runWorkflow} format="webp" alt="Widok ComfyUI" class="mt-0! mb-0!" />
...
Warto pogenerować niejeden raz, gdyż HiggsTTS może wypluć dla jednego zestawu tekst + audio nieco inne, mniej lub bardziej pożądane, brzmienie za każdą generacją.
...
Teksty zostały wygenerowane na podstawie próbek z gry TES V: Skyrim w trakcie prac nad dubbingiem do [House of Horrors - Quest Expansion](https://www.nexusmods.com/skyrimspecialedition/mods/57285) - Jeszcze nie gotowy
...
<i> Tutaj znak zapytania to bardziej hakowanie tonu, by zgadzał się z docelowymi</i>
