...
Przydzielono mi zajmowanie się stroną firmy, [bitapps.fi](https://bitapps.fi/), i pierwszym zadaniem było dostosowanie strony, by dało się przeglądać ją na mobilce oraz pasowała do designu.

Potem wszedł temat interaktywnych map ([rezultat](https://bitapps.fi/solutions.html)) i przez fakt, że strona opierała się na Jekyllu (to silnik prostych stron), trzeba było opracować sposób, by budować i wplatać skrypty do strony.
...
Z czasem przyszła kolejna strona, neituri.fi i tu wybrałem Astro, które wspiera JS natywnie oraz ma wbudowane kompresowanie obrazów.
...
Innym była naprawa zawieszania się procesu CRA w trakcie budowania w pipeline, który udało się rozwiązać metodą prób i błędów właściwie.
